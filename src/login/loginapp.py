...
class LoginApp(CTk):
    def __init__(self):
        ...
        self.phrase_label.place(relx=0.12, rely=0.45)
        ...
        self.login_button = CTkButton(self.right_frame, fg_color="#0836FF", text_color="white", text="Entrar", font=CTkFont(size=15, weight="bold"), width=315, height=45,)
